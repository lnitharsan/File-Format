            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <breeze-nav-link :href="route('files')" :active="route().current('files')">
                                    Files
                                </breeze-nav-link>

                                <breeze-nav-link :href="route('attributes')" :active="route().current('attributes')">
                                    Attributes
                                </breeze-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <breeze-responsive-nav-link :href="route('files')" :active="route().current('files')">
                            Files
                        </breeze-responsive-nav-link>
                        
                        <breeze-responsive-nav-link :href="route('attributes')" :active="route().current('attributes')">
                            Attributes
                        </breeze-responsive-nav-link>
                    </div>
